...
const data = [
    ...
    },
    {
        ...
        'gender': 'male',
        'company': 'MATRIXITY',
        'email': 'duncanrandall@matrixity.com',
        'phone': '+1 (861) 585-3156',
        'address': '860 Lamont Court, Bowden, South Carolina, 3719',
        ...
        'registered': '2015-03-09T02:11:47 -03:00',
        'latitude': -36.819023,
        'longitude': -6.01344,
        'tags': [
            'aliquip',
        ...
        'friends': [
            {
                'id': 0,
                'name': 'Townsend Lindsey'
            },
            {
                'id': 1,
                'name': 'Georgette Blackwell'
            },
            {
                'id': 2,
                'name': 'Knowles Cervantes'
            }
        ],
    ...
    },
    {
        ...
        'phone': '+1 (953) 592-3001',
        'address': '864 Driggs Avenue, Newkirk, New Jersey, 4485',
        'about': 'Laboris ex mollit ut excepteur qui adipisicing magna eu anim nulla anim sint sunt officia. Commodo nisi cupidatat aliquip laboris consectetur et commodo veniam nisi sunt nostrud culpa ipsum laborum. Tempor aliquip sint amet culpa.\r\n',
        'registered': '2016-07-16T09:20:34 -03:00',
        'latitude': 76.633104,
        'longitude': 1.779366,
        'tags': [
            'voluptate',
    ...
    },
    {
        ...
        'gender': 'male',
        'company': 'PARCOE',
        'email': 'parrishjordan@parcoe.com',
        'phone': '+1 (975) 582-2005',
        'address': '178 Franklin Street, Fredericktown, Missouri, 6785',
        'about': 'Officia ex tempor est eiusmod aliquip Lorem. Veniam mollit anim pariatur consequat. Qui exercitation deserunt esse est.\r\n',
        'registered': '2016-04-23T09:49:37 -03:00',
        'latitude': 56.387518,
        'longitude': -32.3259,
        'tags': [
            'pariatur',
        ...
        'friends': [
            ...
            {
                'id': 1,
                'name': 'Fernandez Leach'
            },
            {
                'id': 2,
                'name': 'Crawford Dejesus'
            }
        ],
    ...
    },
    {
        ...
        'greeting': 'Hello, Adela Wooten! You have 7 unread messages.',
        'favouriteFruit': 'strawberry'
    }
];
/* eslint-enable */
...
describe('Task 4', () => {
    it('show users with salaries that are yonger than 30 y.o.', () => {
        expect(showSalary(data, 30)).equal('Golden Branch, $1,825.65\nDuncan Randall, $1,490.15');
    });

    it('show users with salaries that are yonger than 40 y.o.', () => {
        /* eslint-disable */
        expect(showSalary(data, 40)).equal('Golden Branch, $1,825.65\nDuncan Randall, $1,490.15\nGlass Ray, $1,664.27\nHelga Nixon, $1,072.95\nParrish Jordan, $2,560.80');
        /* eslint-enable */
    });
});